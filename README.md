...
**Setup:**
1. Database Setup
I've used **Big Query Sandbox** for transformations.

2. Dashboard
I've used **Tableau Public**
...
"Improvado_Joining_CSVs" - SQL script unifying 3 csv files provided, keeps all the data. Data is saved to BigQuery table "unified_ads_data".
